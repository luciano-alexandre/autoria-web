# Encontro 36 - Funcionalidades JS/DOM - parte 2

**Unidade:** Unidade 4  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Fluxos completos

## Explicacao geral do encontro
Este encontro trabalha **Funcionalidades JS/DOM - parte 2** no projeto integrador, consolidando tecnica e organizacao.
...
## Resumo final
Neste encontro, voce estudou **Funcionalidades JS/DOM - parte 2** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Funcionalidades JS/DOM - parte 2" ajuda a resolver?
