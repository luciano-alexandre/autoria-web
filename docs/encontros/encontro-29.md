# Encontro 29 - Mini projeto JS/DOM (desenvolvimento)

**Unidade:** Unidade 3  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Mini projeto funcional

## Explicacao geral do encontro
Este encontro trabalha **Mini projeto JS/DOM (desenvolvimento)** com JavaScript/DOM para transformar conceito em comportamento visivel.
...
## Resumo final
Neste encontro, voce estudou **Mini projeto JS/DOM (desenvolvimento)** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Mini projeto JS/DOM (desenvolvimento)" ajuda a resolver?
