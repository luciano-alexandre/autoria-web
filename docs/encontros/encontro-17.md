...
**Unidade:** Unidade 2  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Lista 2 entregue

## Explicacao geral do encontro
Este encontro trabalha **Lista de exercícios do bloco 2 (layout e responsividade)** na camada visual, conectando conceitos de CSS com layout real.
...
## Resumo final
Neste encontro, voce estudou **Lista de exercícios do bloco 2 (layout e responsividade)** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Lista de exercícios do bloco 2 (layout e responsividade)" ajuda a resolver?
