# Encontro 5 - Elementos textuais, links e listas

**Unidade:** Unidade 1  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Página textual estruturada

## Explicacao geral do encontro
Este encontro trabalha **Elementos textuais, links e listas** com foco em fundamentos de Web/HTML e autonomia de estudo.
...
- Hierarquia de titulos e paragrafos para leitura web.
- Criacao de links e listas com sentido semantico.
- Clareza textual e escaneabilidade da pagina.

## Explicacao detalhada dos conceitos essenciais
### 1) Hierarquia de titulos e paragrafos para leitura web.
Titulos em ordem logica melhoram leitura humana e navegacao por tecnologias assistivas.

#### Exemplo aplicado
```html
<h1>Titulo principal</h1>
<p>Paragrafo introdutorio.</p>
<ul><li>Item 1</li><li>Item 2</li></ul>
<a href="/contato">Contato</a>
```

### 2) Criacao de links e listas com sentido semantico.
Links descritivos e listas bem organizadas melhoram escaneabilidade do conteudo.
...
### 3) Clareza textual e escaneabilidade da pagina.
Escaneabilidade e leitura rapida com blocos curtos, subtitulos claros e listas objetivas.
...
## Resumo final
Neste encontro, voce estudou **Elementos textuais, links e listas** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Elementos textuais, links e listas" ajuda a resolver?
