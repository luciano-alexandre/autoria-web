# Encontro 31 - Planejamento do projeto final (tema, requisitos, cronograma)

**Unidade:** Unidade 4  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Plano do projeto final

## Explicacao geral do encontro
Este encontro trabalha **Planejamento do projeto final (tema, requisitos, cronograma)** no projeto integrador, consolidando tecnica e organizacao.
...
## Resumo final
Neste encontro, voce estudou **Planejamento do projeto final (tema, requisitos, cronograma)** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Planejamento do projeto final (tema, requisitos, cronograma)" ajuda a resolver?
