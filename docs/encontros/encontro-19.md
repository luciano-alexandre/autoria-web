# Encontro 19 - Apresentação curta do mini projeto (dia reservado)

**Unidade:** Unidade 2  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Mini projeto apresentado

## Explicacao geral do encontro
Este encontro trabalha **Apresentação curta do mini projeto (dia reservado)** na camada visual, conectando conceitos de CSS com layout real.
...
## Resumo final
Neste encontro, voce estudou **Apresentação curta do mini projeto (dia reservado)** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Apresentação curta do mini projeto (dia reservado)" ajuda a resolver?
