...
**Unidade:** Unidade 1  
**Carga prevista:** 1,5h  
**Entregavel previsto:** Mapa conceitual curto

## Explicacao geral do encontro
Este encontro trabalha **Internet x Web, cliente-servidor, URL e HTTP (visão inicial)** com foco em fundamentos de Web/HTML e autonomia de estudo.
...
- Diferenca entre Internet e Web.
- Modelo cliente-servidor, requisicao e resposta.
- Leitura de URL e fundamentos de HTTP.

## Explicacao detalhada dos conceitos essenciais
### 1) Diferenca entre Internet e Web.
Internet e infraestrutura de rede; Web e servico sobre essa rede.

#### Exemplo aplicado
```js
const url = new URL("https://exemplo.com/aula?turma=1");
console.log(url.protocol, url.hostname, url.pathname);
```

### 2) Modelo cliente-servidor, requisicao e resposta.
No ciclo cliente-servidor, o navegador pede recursos e o servidor responde com dados e status.
...
### 3) Leitura de URL e fundamentos de HTTP.
URL identifica recurso e HTTP define regras de troca; dominar isso ajuda a depurar erros 404/500 e links quebrados.
...
## Resumo final
Neste encontro, voce estudou **Internet x Web, cliente-servidor, URL e HTTP (visão inicial)** com foco em compreensao profunda dos conceitos, pratica incremental e revisao tecnica antes da entrega.

## Questoes de fixacao (com gabarito)
1. Qual problema tecnico "Internet x Web, cliente-servidor, URL e HTTP (visão inicial)" ajuda a resolver?
